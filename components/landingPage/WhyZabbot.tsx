      ...
      <main className="text-[#000000] w-full flex justify-between px-4 sm:px-8 md:px-16 lg:px-[100px]">
        <section className="text-[#000000] flex flex-col gap-[31px] lg:w-[55%] pt-12 md:pt-16 lg:pt-[100px]">
          ...
          <div className="gap-[16px] flex flex-col">
            <div className="font-[500] text-[28px] leading-[112%]">
              Tailored Learning Experience
            </div>
            <div className="font-[400] leading-[145%]">
              <span className="font-[700] text-[#333333]">ZABBOT</span>{" "}
              customizes lessons to match your goals and <br />
          ...
          <div className="gap-[16px] flex flex-col">
            ...
            <div className="font-[400] leading-[145%]">
              Learn the language in the context of its rich culture, <br />
          ...
          <div className="gap-[16px] flex flex-col">
            ...
            <div className="font-[400] leading-[145%]">
              From real-world scenarios to conversational practice, we
              <br />
