    ...
    >
      <div className="flex-shrink-0 pb-12 flex gap-[20px] flex-col justify-center items-center">
        <section className="flex flex-col items-center gap-[10px]">
          <div
            className={`font-medium text-[16px] ${theme === "dark" || isDark ? "text-[#F0F0F0]" : "text-[#343434]"
              } leading-[125%] whitespace-nowrap flex-shrink-0`}
          >
            {getPageText("copyright")}
          </div>
          <div
            className={`font-medium text-[14px] ${theme === "dark" || isDark ? "text-[#F0F0F0]" : "text-[#343434]"
              } leading-[125%] whitespace-nowrap flex-shrink-0`}
          >
          ...
          >
            ...
            {' '} · {' '}
            <Link onClick={() => setLoading(true)} href="/privacy-policy">
        ...
        <section className="flex gap-[22px] justify-center items-center">
          ...
          <div className="flex justify-center items-center gap-6">
            <div
              className={`flex items-center gap-2 rounded-full bg-[#5EB3D2] p-[10px] ${theme === "dark" || isDark ? "text-white" : "text-[#012657]"
                } text-2xl`}
            >
              <a
                ...
                className={`${theme === "dark" || isDark ? "text-white" : "text-[#012657]"
                  } text-2xl`}
              >
            ...
            <div
              className={`flex items-center gap-2 rounded-full bg-[#5EB3D2] p-[10px] ${theme === "dark" ? "text-white" : "text-[#012657]"
                } text-2xl`}
            >
              <a
