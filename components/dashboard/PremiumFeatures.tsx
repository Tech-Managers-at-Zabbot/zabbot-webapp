...
const PremiumFeaturesCard: React.FC<PremiumFeaturesData> = ({ data }) => {
  return (
    <>
      <div
        className="relative w-full min-h-[280px] sm:min-h-[320px] md:min-h-[360px] lg:min-h-[400px] border border-gray-200 flex flex-col justify-between text-center rounded-lg p-3 sm:p-4 md:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 ease-in-out transform hover:-translate-y-1"
