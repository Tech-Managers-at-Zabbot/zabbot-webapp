...
const LessonContent = () => {
  ...
  if (!lesson || contents.length === 0) {
    return <div className='bg-[#fef7d0] min-h-screen text-[black]'><EmptyStateCard title='No Data' subtitle='Lesson not found'/></div>;
  }
  return (
    <div className="bg-[#fef7d0] flex justify-center relative min-h-screen w-full" style={{ fontFamily: "Lexend" }}>
      ...
      {showIntro ? (
          <LessonIntro 
            ...
            onClick={()=> {setShowIntro(false); nextContent()}} 
          />
        ) : (
          <ContentRenderer
