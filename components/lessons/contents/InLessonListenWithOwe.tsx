...
interface InLessonListenWithOweProps {
  tone: string;
  title: string;
  description: string;
  onClose: () => void;
...
const InLessonListenWithOwe = ({ tone, title, description, onClose }: InLessonListenWithOweProps) => {
  return (
    <div
...
export default InLessonListenWithOwe;
