...
const ChatWithOre = () => {
  ...
  const { callsRemaining, canMakeCall, TOTAL_CALLS, decrementCalls } =
    useDailyLimit();
      ...
      <main className="flex flex-col bg-[#002557] relative p-5">
        <section className="w-full">
          <div className="flex">
            {/* Left Pane */}
            <div
              className="hidden lg:block w-1/4 max-w-80 border-r p-2 pr-20 bg-[#002557] text-white"
              style={{
                fontFamily: "Lexend",
                fontWeight: 400,
                textAlign: "left",
            ...
            >
              <div className="mb-4">
                <p className="mb-3 text-center">
                  Used {TOTAL_CALLS - callsRemaining} out of {TOTAL_CALLS}
                </p>
              ...
              <button
                ...
                className="w-full bg-blue-500 mb-5 mt-10 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
              >
                + New Chat
              </button>
              ...
              <main className="flex-1 bg-[#04326B] overflow-y-auto p-6 ">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  ...
                  {loading && (
                    <div className="text-gray-500 flex justify-end">
                      <div className="pr-12 text-xl">Ọ̀rẹ́ is typing...</div>
                    </div>
                  )}
                </div>
                ...
                <div className="flex flex-col items-center ">
                  <p className="text-white-500 font-[400] text-[14px] mt-1">
                    Ọ̀rẹ́ can make mistakes. Consider checking important
                    information.
                  </p>
                </div>
